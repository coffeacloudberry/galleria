...
export const config = {
    ...
    mapbox: {
        ...
        css: {
            src: "https://api.mapbox.com/mapbox-gl-js/v2.6.1/mapbox-gl.css",
        ...
        js: {
            ...
            sri: "sha512-tDQO9aI6VVbd2ZlHpKzQonF99PzAfL7UOu97y3s+DLQPXS0oE35AFmmy4NU26g576EIHobNpRWn0p85+n5659Q==",
        },

...
export const config = {
    ...
    mapbox: {
        ...
        css: {
            src: "https://api.mapbox.com/mapbox-gl-js/v3.1.0/mapbox-gl.css",
        ...
        js: {
            ...
            sri: "sha512-HvbZxJlF/g7dQDyBFheXq4QTIgzVhPeo4C/Eh/EBCZD2i+q6eq6mBAPruZaSHpaVd+m+0vzfnql8cHBBq3E69Q==",
        },

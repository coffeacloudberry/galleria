...
class StoriesPlugin {
    ...
    writeInfoFile(genDir, contentObject) {
    ...
    listStories() {
        ...
        try {
            ...
            for (const photoId of allPhotos) {
                ...
                const genDir = `${photoDir}/${this.autoGeneratedDirName}`;
                ...
                this.writeInfoFile(genDir, PhotoData);
            }
            ...
            for (const storyId of allStories) {
                ...
                const genDir = `${storyDir}/${this.autoGeneratedDirName}`;
                this.writeInfoFile(genDir, photosInStories[storyId]);
            }
